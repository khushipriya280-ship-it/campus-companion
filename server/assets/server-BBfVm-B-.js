...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DB1UyAVN.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-JuGXojPN.js"),
		import("./start-BCcuee9G.js"),
...
var ROUTER_BASEPATH = "campus-companion";
var SERVER_FN_BASE = "/campus-companion/_serverFn/";
